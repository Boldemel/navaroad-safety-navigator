...
import tierOwner from "@/assets/tier-owner-final.jpg.asset.json";
import tierSmall from "@/assets/tier-small-mountain.jpeg.asset.json";
import tierGrowth from "@/assets/tier-growth-final.jpg.asset.json";
import tierEnterprise from "@/assets/tier-enterprise-final.jpg.asset.json";
...
const TIERS = [
  ...
  },
  {
    ...
    price: "Contact Sales",
    tagline:
      "Custom FleetOS solutions for large carriers, enterprise fleets, and organizations requiring advanced integrations, dedicated support, and custom deployment.",
    features: [
      "Unlimited Trucks",
      "Unlimited Drivers",
      "Unlimited Users",
    ...
    ctaHref: "mailto:sales@navaroad.com",
    note: "Custom pricing is based on fleet size, users, integrations, and business requirements.",
  },
];
